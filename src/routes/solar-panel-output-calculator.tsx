...
const calculatorId = 'solar-panel-output-calculator';

export const Route = createFileRoute('/solar-panel-output-calculator')({
  component: OutputCalculatorPage,
  head: () => {
    const seo = getSEOData(calculatorId);
    return {
      title: seo?.seoTitle || 'Solar Panel Output Calculator',
      meta: [
      ...
      links: [
        { rel: 'canonical', href: `https://solarpanel-calculator.com/solar-panel-output-calculator` },
      ],
    };
  },
});

function OutputCalculatorPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-6xl">
            ...
            {results ? (
              ...
              <div className="h-full flex items-center justify-center border-dashed bg-slate-50 min-h-[400px] rounded-xl border">
                <div className="text-center p-8">
                  <p className="text-slate-500 font-medium">Enter your system details to see estimated output</p>
                </div>
              </div>
            )}
          </div>
      ...
      <div className="mt-12 space-y-12">
        <Disclaimer context="output estimates" />
