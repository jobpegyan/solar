...
const calculatorId = 'solar-panel-roi-calculator';

export const Route = createFileRoute('/solar-panel-roi-calculator')({
  component: ROICalculatorPage,
  head: () => {
    const seo = getSEOData(calculatorId);
    return {
      title: seo?.seoTitle || 'Solar Panel ROI Calculator',
      meta: [
      ...
      links: [
        { rel: 'canonical', href: `https://solarpanel-calculator.com/solar-panel-roi-calculator` },
      ],
    };
  },
});
  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-6xl">
      ...
      <div className="mt-12 space-y-12">
        <Disclaimer context="ROI estimates" />
